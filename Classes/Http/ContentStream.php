<?php
namespace Wwwision\ImportService\Http;
...
class ContentStream implements StreamInterface
{
    ...
    public function __toString()
    {
        ...
        try {
            ...
            $this->logger->log(sprintf('Tried to convert a http content stream to a string but an exception occured: [%s] - %s', $e->getCode(), $e->getMessage()), LOG_ERR);
            return '';
        }
    }
}
